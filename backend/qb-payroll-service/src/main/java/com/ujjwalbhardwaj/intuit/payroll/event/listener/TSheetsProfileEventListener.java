...
public class TSheetsProfileEventListener {
    private final BusinessService businessService;
    private final KafkaTemplate<String, ProfileValidationEventPayload> kafkaTemplate;
    private final ObjectMapper objectMapper;

    @KafkaListener(topics = "business-profile-validator", groupId = "tsheets-profile-consumer-group")
